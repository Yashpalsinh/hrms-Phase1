...
<%@page import="com.hrms.service.EmployeeMasterLocalServiceUtil"%>
...
<%
	...
	EmployeeMaster empMaster = EmployeeMasterLocalServiceUtil
			.findEmployeeByUserId(userId);
	User user = UserLocalServiceUtil.getUser(userId);
	EmployeeType empType = EmployeeTypeLocalServiceUtil
			.getEmployeeType(empMaster.getEmployeeTypeId());
	EmployeeDesignation empDesignation = EmployeeDesignationLocalServiceUtil
			.getEmployeeDesignation(empMaster
...
<table>
  ...
  <tr>
  	<td>Employee Type</td>
  	<td> : </td>
  	<td><b>&nbsp<%=	empType.getEmployeeTypeName().toString()%></b></td>
  </tr>
  <tr>
