...
<%@ page import="com.hrms.model.EmployeeSubDepartment" %>
...
<%@page import="com.hrms.EmployeeSubDepartmentComparator"%>
<%@page import="com.liferay.portal.kernel.util.Constants"%>
<%@page import="com.liferay.portal.kernel.util.ParamUtil" %>
<%@page import="com.liferay.portlet.PortalPreferences"%>
<%@page import="com.liferay.portlet.PortletPreferencesFactoryUtil" %>
<%@page import="javax.portlet.PortletPreferences"%>
<%@page import="com.hrms.EmployeeSubDepartmentCont"%>
<%@ page import="com.liferay.portal.kernel.util.Constants" %>
...
long employeeSubDepartmentIda = ParamUtil.getLong(request, "employeeSubDepartmentIda");
long employeeDepartmentIda = ParamUtil.getLong(request, "employeeDepartmentIda");
String subDepartmentNamea = ParamUtil.getString(request, "subDepartmentNamea");
