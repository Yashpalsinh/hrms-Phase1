...
import com.hrms.service.EmployeeMstLocalService;
...
/**
 * Provides the base implementation for the employee mst local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.hrms.service.impl.EmployeeMstLocalServiceImpl}.
 * </p>
 *
 * @author yashpalsinh
 ...
 * @generated
 */
public abstract class EmployeeMstLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements EmployeeMstLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.hrms.service.EmployeeMstLocalServiceUtil} to access the employee mst local service.
	 */
	...
	@Override
	public EmployeeMst addEmployeeMst(EmployeeMst employeeMst)
		throws SystemException {
		employeeMst.setNew(true);

		return employeeMstPersistence.update(employeeMst);
	}
	 ...
	 */
	@Override
	public EmployeeMst createEmployeeMst(long employeeMstId) {
		return employeeMstPersistence.create(employeeMstId);
	}
	...
	@Override
	public EmployeeMst deleteEmployeeMst(long employeeMstId)
		throws PortalException, SystemException {
		return employeeMstPersistence.remove(employeeMstId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmployeeMst deleteEmployeeMst(EmployeeMst employeeMst)
		throws SystemException {
		return employeeMstPersistence.remove(employeeMst);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EmployeeMst.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return employeeMstPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return employeeMstPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return employeeMstPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public EmployeeMst fetchEmployeeMst(long employeeMstId)
		throws SystemException {
		return employeeMstPersistence.fetchByPrimaryKey(employeeMstId);
	}
	 ...
	 */
	@Override
	public EmployeeMst getEmployeeMst(long employeeMstId)
		throws PortalException, SystemException {
		return employeeMstPersistence.findByPrimaryKey(employeeMstId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return employeeMstPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmployeeMst> getEmployeeMsts(int start, int end)
		throws SystemException {
		return employeeMstPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getEmployeeMstsCount() throws SystemException {
		return employeeMstPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmployeeMst updateEmployeeMst(EmployeeMst employeeMst)
		throws SystemException {
		return employeeMstPersistence.update(employeeMst);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.hrms.model.EmployeeMst",
			employeeMstLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.hrms.model.EmployeeMst");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = employeeMstPersistence.getDataSource();
	...
	private EmployeeMstLocalServiceClpInvoker _clpInvoker = new EmployeeMstLocalServiceClpInvoker();
}