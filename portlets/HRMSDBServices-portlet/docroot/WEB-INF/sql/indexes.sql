...
create index IX_4055061F on HRMS_EmployeeMaster (recruitedBy);
...
create index IX_E15C2042 on HRMS_EmployeeProof (proofId);
create index IX_CF855E87 on HRMS_EmployeeProof (userId);
