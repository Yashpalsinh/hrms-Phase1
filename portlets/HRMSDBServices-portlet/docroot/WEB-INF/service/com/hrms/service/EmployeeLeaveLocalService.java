...
/**
 * Provides the local service interface for EmployeeLeave. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author yashpalsinh
 * @see EmployeeLeaveLocalServiceUtil
...
public interface EmployeeLeaveLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EmployeeLeaveLocalServiceUtil} to access the employee leave local service. Add custom service methods to {@link com.hrms.service.impl.EmployeeLeaveLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
