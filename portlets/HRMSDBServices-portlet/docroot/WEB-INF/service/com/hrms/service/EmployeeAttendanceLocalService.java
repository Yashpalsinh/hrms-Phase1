...
/**
 * Provides the local service interface for EmployeeAttendance. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author bhavik
 * @see EmployeeAttendanceLocalServiceUtil
...
public interface EmployeeAttendanceLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EmployeeAttendanceLocalServiceUtil} to access the employee attendance local service. Add custom service methods to {@link com.hrms.service.impl.EmployeeAttendanceLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
