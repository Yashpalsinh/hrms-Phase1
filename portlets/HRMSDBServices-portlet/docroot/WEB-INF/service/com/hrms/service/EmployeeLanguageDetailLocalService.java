...
/**
 * Provides the local service interface for EmployeeLanguageDetail. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author bhavik
 * @see EmployeeLanguageDetailLocalServiceUtil
...
public interface EmployeeLanguageDetailLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EmployeeLanguageDetailLocalServiceUtil} to access the employee language detail local service. Add custom service methods to {@link com.hrms.service.impl.EmployeeLanguageDetailLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
