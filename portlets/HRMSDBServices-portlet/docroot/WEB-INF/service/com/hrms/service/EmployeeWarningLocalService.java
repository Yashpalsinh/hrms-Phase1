...
/**
 * Provides the local service interface for EmployeeWarning. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author bhavik
 * @see EmployeeWarningLocalServiceUtil
...
public interface EmployeeWarningLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EmployeeWarningLocalServiceUtil} to access the employee warning local service. Add custom service methods to {@link com.hrms.service.impl.EmployeeWarningLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
