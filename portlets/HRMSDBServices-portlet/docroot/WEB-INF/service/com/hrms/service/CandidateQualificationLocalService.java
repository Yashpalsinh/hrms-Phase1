...
/**
 * Provides the local service interface for CandidateQualification. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author yashpalsinh
 * @see CandidateQualificationLocalServiceUtil
...
public interface CandidateQualificationLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CandidateQualificationLocalServiceUtil} to access the candidate qualification local service. Add custom service methods to {@link com.hrms.service.impl.CandidateQualificationLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
