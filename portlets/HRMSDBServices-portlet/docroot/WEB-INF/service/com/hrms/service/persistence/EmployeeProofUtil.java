...
/**
 * The persistence utility for the employee proof service. This utility wraps {@link EmployeeProofPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see EmployeeProofPersistenceImpl
 * @generated
 */
public class EmployeeProofUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(EmployeeProof employeeProof) {
		getPersistence().clearCache(employeeProof);
	}
	 ...
	 */
	public static List<EmployeeProof> findWithDynamicQuery(
	 ...
	 */
	public static EmployeeProof update(EmployeeProof employeeProof)
		throws SystemException {
		return getPersistence().update(employeeProof);
	}
	...
	public static EmployeeProof update(EmployeeProof employeeProof,
		...
		return getPersistence().update(employeeProof, serviceContext);
	}
	...
	*/
	public static com.hrms.model.EmployeeProof create(long employeeproofNo) {
		return getPersistence().create(employeeproofNo);
	}
	...
	*/
	public static com.hrms.model.EmployeeProof remove(long employeeproofNo)
		throws com.hrms.NoSuchEmployeeProofException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(employeeproofNo);
	}

	public static com.hrms.model.EmployeeProof updateImpl(
		com.hrms.model.EmployeeProof employeeProof)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(employeeProof);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.hrms.model.EmployeeProof findByPrimaryKey(
		long employeeproofNo)
		throws com.hrms.NoSuchEmployeeProofException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().findByPrimaryKey(employeeproofNo);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.hrms.model.EmployeeProof fetchByPrimaryKey(
		long employeeproofNo)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(employeeproofNo);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.hrms.model.EmployeeProof> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static EmployeeProofPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (EmployeeProofPersistence)PortletBeanLocatorUtil.locate(com.hrms.service.ClpSerializer.getServletContextName(),
					EmployeeProofPersistence.class.getName());

			ReferenceRegistry.registerReference(EmployeeProofUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(EmployeeProofPersistence persistence) {
	}

	private static EmployeeProofPersistence _persistence;
}