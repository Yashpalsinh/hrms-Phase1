...
public class OfferLocalServiceClp implements OfferLocalService {
	public OfferLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public com.hrms.model.Offer addOffer(com.hrms.model.Offer offer)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(offer) });
		}
		catch (Throwable t) {
		...
		return (com.hrms.model.Offer)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.hrms.model.Offer> getOffers(int start, int end)
		...
		return (java.util.List<com.hrms.model.Offer>)ClpSerializer.translateOutput(returnObj);
	}
