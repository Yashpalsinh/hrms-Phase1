...
public class EmployeeSubDepartmentLocalServiceUtil {
	...
	*/
	...
	public static java.util.List getSerachEmployeeSubDepartments(
		java.lang.String subDepartmentName, java.lang.String status,
		long departmentId, boolean andSearch, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .getSerachEmployeeSubDepartments(subDepartmentName, status,
			departmentId, andSearch, start, end, orderByComparator);
	}

	public static int getSearchEmployeeSubDepartmentsCount(
		java.lang.String subDepartmentName, java.lang.String status,
		long departmentId, boolean andSearch)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .getSearchEmployeeSubDepartmentsCount(subDepartmentName,
			status, departmentId, andSearch);
	}

	public static java.util.List<com.hrms.model.EmployeeSubDepartment> findByDeptAndStatus(
		long deptId, boolean stat)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findByDeptAndStatus(deptId, stat);
	}
