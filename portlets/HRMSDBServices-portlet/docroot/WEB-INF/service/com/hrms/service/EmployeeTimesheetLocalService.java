...
/**
 * Provides the local service interface for EmployeeTimesheet. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author bhavik
 * @see EmployeeTimesheetLocalServiceUtil
...
public interface EmployeeTimesheetLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EmployeeTimesheetLocalServiceUtil} to access the employee timesheet local service. Add custom service methods to {@link com.hrms.service.impl.EmployeeTimesheetLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
