...
public class ProofWrapper implements Proof, ModelWrapper<Proof> {
	...
	*/
	...
	@Override
	public int compareTo(com.hrms.model.Proof proof) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.hrms.model.Proof> toCacheModel() {
		return _proof.toCacheModel();
	}

	@Override
	public com.hrms.model.Proof toEscapedModel() {
		return new ProofWrapper(_proof.toEscapedModel());
	}

	@Override
	public com.hrms.model.Proof toUnescapedModel() {
