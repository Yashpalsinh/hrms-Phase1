...
import com.hrms.service.TodoLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.hrms.service.impl.TodoLocalServiceImpl}.
 * </p>
 *
 * @author yashpalsinh
...
public abstract class TodoLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.hrms.service.TodoLocalServiceUtil} to access the todo local service.
	 */
	 ...
	 */
	@Override
	public Todo createTodo(long taskId) {
		return todoPersistence.create(taskId);
	}
	...
	@Override
	public Todo deleteTodo(long taskId) throws PortalException, SystemException {
		return todoPersistence.remove(taskId);
	}
	...
	@Override
	public Todo fetchTodo(long taskId) throws SystemException {
		return todoPersistence.fetchByPrimaryKey(taskId);
	}
	 ...
	 */
	@Override
	public Todo getTodo(long taskId) throws PortalException, SystemException {
		return todoPersistence.findByPrimaryKey(taskId);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.hrms.model.Todo",
			todoLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister("com.hrms.model.Todo");
	}
