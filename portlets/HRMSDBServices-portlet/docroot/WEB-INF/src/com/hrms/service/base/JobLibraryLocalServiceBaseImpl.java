...
import com.hrms.service.JobLibraryLocalService;
...
/**
 * Provides the base implementation for the job library local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.hrms.service.impl.JobLibraryLocalServiceImpl}.
 * </p>
 *
 * @author yashpalsinh
 ...
 * @generated
 */
public abstract class JobLibraryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements JobLibraryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.hrms.service.JobLibraryLocalServiceUtil} to access the job library local service.
	 */
	...
	@Override
	public JobLibrary addJobLibrary(JobLibrary jobLibrary)
		throws SystemException {
		jobLibrary.setNew(true);

		return jobLibraryPersistence.update(jobLibrary);
	}
	 ...
	 */
	@Override
	public JobLibrary createJobLibrary(long jobLibraryId) {
		return jobLibraryPersistence.create(jobLibraryId);
	}
	...
	@Override
	public JobLibrary deleteJobLibrary(long jobLibraryId)
		throws PortalException, SystemException {
		return jobLibraryPersistence.remove(jobLibraryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public JobLibrary deleteJobLibrary(JobLibrary jobLibrary)
		throws SystemException {
		return jobLibraryPersistence.remove(jobLibrary);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(JobLibrary.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return jobLibraryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return jobLibraryPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return jobLibraryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public JobLibrary fetchJobLibrary(long jobLibraryId)
		throws SystemException {
		return jobLibraryPersistence.fetchByPrimaryKey(jobLibraryId);
	}
	 ...
	 */
	@Override
	public JobLibrary getJobLibrary(long jobLibraryId)
		throws PortalException, SystemException {
		return jobLibraryPersistence.findByPrimaryKey(jobLibraryId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return jobLibraryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<JobLibrary> getJobLibraries(int start, int end)
		throws SystemException {
		return jobLibraryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getJobLibrariesCount() throws SystemException {
		return jobLibraryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public JobLibrary updateJobLibrary(JobLibrary jobLibrary)
		throws SystemException {
		return jobLibraryPersistence.update(jobLibrary);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.hrms.model.JobLibrary",
			jobLibraryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.hrms.model.JobLibrary");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = jobLibraryPersistence.getDataSource();
	...
	private JobLibraryLocalServiceClpInvoker _clpInvoker = new JobLibraryLocalServiceClpInvoker();
}