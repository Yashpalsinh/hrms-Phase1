...
import com.hrms.service.EmployeeProofLocalService;
...
/**
 * Provides the base implementation for the employee proof local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.hrms.service.impl.EmployeeProofLocalServiceImpl}.
 * </p>
 *
 * @author yashpalsinh
 ...
 * @generated
 */
public abstract class EmployeeProofLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements EmployeeProofLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.hrms.service.EmployeeProofLocalServiceUtil} to access the employee proof local service.
	 */
	...
	@Override
	public EmployeeProof addEmployeeProof(EmployeeProof employeeProof)
		throws SystemException {
		employeeProof.setNew(true);

		return employeeProofPersistence.update(employeeProof);
	}
	 ...
	 */
	@Override
	public EmployeeProof createEmployeeProof(long employeeproofNo) {
		return employeeProofPersistence.create(employeeproofNo);
	}
	...
	@Override
	public EmployeeProof deleteEmployeeProof(long employeeproofNo)
		throws PortalException, SystemException {
		return employeeProofPersistence.remove(employeeproofNo);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmployeeProof deleteEmployeeProof(EmployeeProof employeeProof)
		throws SystemException {
		return employeeProofPersistence.remove(employeeProof);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EmployeeProof.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return employeeProofPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return employeeProofPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public EmployeeProof fetchEmployeeProof(long employeeproofNo)
		throws SystemException {
		return employeeProofPersistence.fetchByPrimaryKey(employeeproofNo);
	}
	 ...
	 */
	@Override
	public EmployeeProof getEmployeeProof(long employeeproofNo)
		throws PortalException, SystemException {
		return employeeProofPersistence.findByPrimaryKey(employeeproofNo);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return employeeProofPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmployeeProof> getEmployeeProofs(int start, int end)
		throws SystemException {
		return employeeProofPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getEmployeeProofsCount() throws SystemException {
		return employeeProofPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmployeeProof updateEmployeeProof(EmployeeProof employeeProof)
		throws SystemException {
		return employeeProofPersistence.update(employeeProof);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.hrms.model.EmployeeProof",
			employeeProofLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.hrms.model.EmployeeProof");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = employeeProofPersistence.getDataSource();
	...
	private EmployeeProofLocalServiceClpInvoker _clpInvoker = new EmployeeProofLocalServiceClpInvoker();
}