...
import com.hrms.service.EmployeeSubDepartmentLocalService;
...
/**
 * Provides the base implementation for the employee sub department local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.hrms.service.impl.EmployeeSubDepartmentLocalServiceImpl}.
 * </p>
 *
 * @author yashpalsinh
 ...
 * @generated
 */
public abstract class EmployeeSubDepartmentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements EmployeeSubDepartmentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.hrms.service.EmployeeSubDepartmentLocalServiceUtil} to access the employee sub department local service.
	 */
	...
	@Override
	public EmployeeSubDepartment addEmployeeSubDepartment(
		EmployeeSubDepartment employeeSubDepartment) throws SystemException {
		employeeSubDepartment.setNew(true);

		return employeeSubDepartmentPersistence.update(employeeSubDepartment);
	}
	 ...
	 */
	@Override
	public EmployeeSubDepartment createEmployeeSubDepartment(
		long employeeSubDepartmentId) {
		return employeeSubDepartmentPersistence.create(employeeSubDepartmentId);
	}
	...
	@Override
	public EmployeeSubDepartment deleteEmployeeSubDepartment(
		long employeeSubDepartmentId) throws PortalException, SystemException {
		return employeeSubDepartmentPersistence.remove(employeeSubDepartmentId);
	}
	...
	public EmployeeSubDepartment deleteEmployeeSubDepartment(
		EmployeeSubDepartment employeeSubDepartment) throws SystemException {
		return employeeSubDepartmentPersistence.remove(employeeSubDepartment);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EmployeeSubDepartment.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return employeeSubDepartmentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return employeeSubDepartmentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public EmployeeSubDepartment fetchEmployeeSubDepartment(
		long employeeSubDepartmentId) throws SystemException {
		return employeeSubDepartmentPersistence.fetchByPrimaryKey(employeeSubDepartmentId);
	}
	 ...
	 */
	@Override
	public EmployeeSubDepartment getEmployeeSubDepartment(
		long employeeSubDepartmentId) throws PortalException, SystemException {
		return employeeSubDepartmentPersistence.findByPrimaryKey(employeeSubDepartmentId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return employeeSubDepartmentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmployeeSubDepartment> getEmployeeSubDepartments(int start,
		int end) throws SystemException {
		return employeeSubDepartmentPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getEmployeeSubDepartmentsCount() throws SystemException {
		return employeeSubDepartmentPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmployeeSubDepartment updateEmployeeSubDepartment(
		EmployeeSubDepartment employeeSubDepartment) throws SystemException {
		return employeeSubDepartmentPersistence.update(employeeSubDepartment);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.hrms.model.EmployeeSubDepartment",
			employeeSubDepartmentLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = employeeSubDepartmentPersistence.getDataSource();
	...
	private EmployeeSubDepartmentLocalServiceClpInvoker _clpInvoker = new EmployeeSubDepartmentLocalServiceClpInvoker();
}