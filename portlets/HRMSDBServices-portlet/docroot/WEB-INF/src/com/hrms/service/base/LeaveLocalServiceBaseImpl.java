...
import com.hrms.service.LeaveLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.hrms.service.impl.LeaveLocalServiceImpl}.
 * </p>
 *
 * @author yashpalsinh
...
public abstract class LeaveLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements LeaveLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.hrms.service.LeaveLocalServiceUtil} to access the leave local service.
	 */
	...
	@Override
	public Leave addLeave(Leave leave) throws SystemException {
		leave.setNew(true);
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Leave deleteLeave(Leave leave) throws SystemException {
	...
	@Override
	public Leave fetchLeave(long leaveId) throws SystemException {
	 ...
	 */
	@Override
	public Leave getLeave(long leaveId) throws PortalException, SystemException {
	 ...
	 */
	@Override
	public List<Leave> getLeaves(int start, int end) throws SystemException {
	 ...
	 */
	@Override
	public int getLeavesCount() throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Leave updateLeave(Leave leave) throws SystemException {
		return leavePersistence.update(leave);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.hrms.model.Leave",
			leaveLocalService);
	}
	...
	private LeaveLocalServiceClpInvoker _clpInvoker = new LeaveLocalServiceClpInvoker();
}