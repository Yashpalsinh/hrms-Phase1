...
import com.hrms.service.ProofLocalService;
...
/**
 * Provides the base implementation for the proof local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.hrms.service.impl.ProofLocalServiceImpl}.
 * </p>
 *
 * @author yashpalsinh
 ...
 * @generated
 */
public abstract class ProofLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ProofLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.hrms.service.ProofLocalServiceUtil} to access the proof local service.
	 */
	...
	@Override
	public Proof addProof(Proof proof) throws SystemException {
		proof.setNew(true);

		return proofPersistence.update(proof);
	}
	 ...
	 */
	@Override
	public Proof createProof(long proofId) {
		return proofPersistence.create(proofId);
	}
	...
	@Override
	public Proof deleteProof(long proofId)
		throws PortalException, SystemException {
		return proofPersistence.remove(proofId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Proof deleteProof(Proof proof) throws SystemException {
		return proofPersistence.remove(proof);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Proof.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return proofPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return proofPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return proofPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return proofPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Proof fetchProof(long proofId) throws SystemException {
		return proofPersistence.fetchByPrimaryKey(proofId);
	}
	 ...
	 */
	@Override
	public Proof getProof(long proofId) throws PortalException, SystemException {
		return proofPersistence.findByPrimaryKey(proofId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return proofPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Proof> getProofs(int start, int end) throws SystemException {
		return proofPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getProofsCount() throws SystemException {
		return proofPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Proof updateProof(Proof proof) throws SystemException {
		return proofPersistence.update(proof);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.hrms.model.Proof",
			proofLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = proofPersistence.getDataSource();
	...
	private ProofLocalServiceClpInvoker _clpInvoker = new ProofLocalServiceClpInvoker();
}