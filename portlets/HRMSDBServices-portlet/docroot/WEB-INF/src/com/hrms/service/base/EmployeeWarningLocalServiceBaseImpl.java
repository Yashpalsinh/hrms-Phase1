...
import com.hrms.service.EmployeeWarningLocalService;
...
/**
 * Provides the base implementation for the employee warning local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.hrms.service.impl.EmployeeWarningLocalServiceImpl}.
 * </p>
 *
 * @author yashpalsinh
 ...
 * @generated
 */
public abstract class EmployeeWarningLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements EmployeeWarningLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.hrms.service.EmployeeWarningLocalServiceUtil} to access the employee warning local service.
	 */
	...
	@Override
	public EmployeeWarning addEmployeeWarning(EmployeeWarning employeeWarning)
		throws SystemException {
		employeeWarning.setNew(true);

		return employeeWarningPersistence.update(employeeWarning);
	}
	 ...
	 */
	@Override
	public EmployeeWarning createEmployeeWarning(long employeeWarningId) {
		return employeeWarningPersistence.create(employeeWarningId);
	}
	...
	@Override
	public EmployeeWarning deleteEmployeeWarning(long employeeWarningId)
		throws PortalException, SystemException {
		return employeeWarningPersistence.remove(employeeWarningId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmployeeWarning deleteEmployeeWarning(
		EmployeeWarning employeeWarning) throws SystemException {
		return employeeWarningPersistence.remove(employeeWarning);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EmployeeWarning.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return employeeWarningPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return employeeWarningPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public EmployeeWarning fetchEmployeeWarning(long employeeWarningId)
		throws SystemException {
		return employeeWarningPersistence.fetchByPrimaryKey(employeeWarningId);
	}
	 ...
	 */
	@Override
	public EmployeeWarning getEmployeeWarning(long employeeWarningId)
		throws PortalException, SystemException {
		return employeeWarningPersistence.findByPrimaryKey(employeeWarningId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return employeeWarningPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmployeeWarning> getEmployeeWarnings(int start, int end)
		throws SystemException {
		return employeeWarningPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getEmployeeWarningsCount() throws SystemException {
		return employeeWarningPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmployeeWarning updateEmployeeWarning(
		EmployeeWarning employeeWarning) throws SystemException {
		return employeeWarningPersistence.update(employeeWarning);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.hrms.model.EmployeeWarning",
			employeeWarningLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.hrms.model.EmployeeWarning");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = employeeWarningPersistence.getDataSource();
	...
	private EmployeeWarningLocalServiceClpInvoker _clpInvoker = new EmployeeWarningLocalServiceClpInvoker();
}