...
import com.hrms.service.EmployeeAttendanceLocalService;
...
/**
 * Provides the base implementation for the employee attendance local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.hrms.service.impl.EmployeeAttendanceLocalServiceImpl}.
 * </p>
 *
 * @author yashpalsinh
 ...
 * @generated
 */
public abstract class EmployeeAttendanceLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements EmployeeAttendanceLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.hrms.service.EmployeeAttendanceLocalServiceUtil} to access the employee attendance local service.
	 */
	...
	@Override
	public EmployeeAttendance addEmployeeAttendance(
		EmployeeAttendance employeeAttendance) throws SystemException {
		employeeAttendance.setNew(true);

		return employeeAttendancePersistence.update(employeeAttendance);
	}
	 ...
	 */
	@Override
	public EmployeeAttendance createEmployeeAttendance(long attendanceId) {
		return employeeAttendancePersistence.create(attendanceId);
	}
	...
	@Override
	public EmployeeAttendance deleteEmployeeAttendance(long attendanceId)
		throws PortalException, SystemException {
		return employeeAttendancePersistence.remove(attendanceId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmployeeAttendance deleteEmployeeAttendance(
		EmployeeAttendance employeeAttendance) throws SystemException {
		return employeeAttendancePersistence.remove(employeeAttendance);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EmployeeAttendance.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return employeeAttendancePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return employeeAttendancePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public EmployeeAttendance fetchEmployeeAttendance(long attendanceId)
		throws SystemException {
		return employeeAttendancePersistence.fetchByPrimaryKey(attendanceId);
	}
	 ...
	 */
	@Override
	public EmployeeAttendance getEmployeeAttendance(long attendanceId)
		throws PortalException, SystemException {
		return employeeAttendancePersistence.findByPrimaryKey(attendanceId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return employeeAttendancePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmployeeAttendance> getEmployeeAttendances(int start, int end)
		throws SystemException {
		return employeeAttendancePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getEmployeeAttendancesCount() throws SystemException {
		return employeeAttendancePersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.hrms.model.EmployeeAttendance",
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = employeeAttendancePersistence.getDataSource();
	...
	private EmployeeAttendanceLocalServiceClpInvoker _clpInvoker = new EmployeeAttendanceLocalServiceClpInvoker();
}